...
public:
	...
	int ads_send(const a& outputBase, const unsigned long& offsetAddress, const b& dataSize,
	             const c& data)
	{
	...
	template <typename a, typename b, typename c>
	int ads_receive(const a& inputBase, const unsigned long& offsetAddress, const b& dataSize,
	                const c& data)
	{
